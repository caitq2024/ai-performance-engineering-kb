...
- `chapter06-lecture-script-v2-zh.md`: revised 53-page bilingual lecture script with the factory/workshop narrative and updated transitions.
- `chapter06-presentation.tex`: editable Beamer presentation source.
- `chapter06-presentation.pdf`: rendered 52-page presentation.
- `chapter06-presentation-v2.pdf`: revised 53-page presentation aligned with the v2 lecture script.
- `chapter06.pdf`: extracted source chapter PDF (48 pages).
- `figs/fig6-*.png`: 22 supporting figures referenced by the presentation.
